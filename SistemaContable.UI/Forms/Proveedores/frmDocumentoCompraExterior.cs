...
{
    public partial class frmDocumentoCompraExterior : Form
    {
        ...
        private void CargarCompraExteriorExistente(int idCompraExterior)
        {
            try
            {
        ...
        {
            CargarCombo("[EPROVEEDOR].[SP_TIPO_DTE]", "BUSCAR_COMPRAS_EXT", "ID_TIPO_DTE", "ABREVIATURA", cbxTIPO_DTE);
        ...
        private void SeleccionarRentaPorTipoDocumento()
        {
            ...
            foreach (DataRow fila in tabla.Rows)
            {
                ...
                if (codigoDocumento == "TEI"
                    && !Convert.ToString(fila["DESCRIPCION"]).ToUpperInvariant().Contains("TE"))
                    continue;
        ...
        {
            if (IdCompraExterior == 0 && !string.IsNullOrWhiteSpace(txtCOD_GENERACION.Text.Trim()) && !string.IsNullOrWhiteSpace(txtNUM_CONTROL.Text.Trim()))
            {
        ...
        // ================================================================
        //  frmDocumentoCompraExterior - Operación GUARDAR (atómica vía SP)
        //
        //  El SP_COMPRA_EXTERIOR.GUARDAR maneja internamente:
        //    - Si @ID_COMPRA_EXTERIOR = 0 y @ID_QUEDAN_CEX = 0  -> crea Quedan CEX + compra
        //    - Si @ID_COMPRA_EXTERIOR = 0 y @ID_QUEDAN_CEX > 0  -> reutiliza el mismo Quedan CEX
        //    - Si @ID_COMPRA_EXTERIOR > 0                   -> UPDATE del CCF
        //
        ...
        private void btnProvision_Click(object sender, EventArgs e)
        {
            ...
            {
                frm.IdCcfCompra = IdCompraExterior;
                frm.ShowDialog(this);
            }
        }
