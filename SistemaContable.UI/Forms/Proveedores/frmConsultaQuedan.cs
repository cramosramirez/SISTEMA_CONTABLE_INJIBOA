...
namespace SistemaContable.UI.Forms.Proveedores
{
    public partial class frmConsultaQuedan : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            // Columnas ficticias para los botones por fila
            foreach (string col in new[] { "EDITAR", "VER_Q", "VER_R" })
            {
                if (!_dtDetalle.Columns.Contains(col))
                    _dtDetalle.Columns.Add(col, typeof(string));
            }
        ...
        private int? ObtenerIdCcfFilaActiva()
        {
        ...
        private void AbrirDocumentoCompra(int idCcfCompra)
        {
