...
{
    public partial class frmConsultadz : Form
    {
        private readonly DALBase _dal = new DALBase();
        private DataTable _dtDetalle;

        public frmConsultadz()
        {
            InitializeComponent();
        }
        ...
        private void frmConsultadz_Load(object sender, EventArgs e)
        {
            ConfigurarGrid();
            CargarDatos();
        }
        ...
        {
            using (var frm = new frmTrasladodz())
            {
        ...
        private void gvDetalle_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            if (e.Column == colVER_Q)
            {
                ...
                try
                {
                    ...
                    var reporte = new RptNotaRemision_Venta_Dizucar { _id = (int)id };
