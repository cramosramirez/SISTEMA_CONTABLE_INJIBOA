...
{
    public partial class frmConsultaDespacho : Form
    {
        private readonly DALBase _dal = new DALBase();
        private DataTable _dtDetalle;

        public frmConsultaDespacho()
        {
            InitializeComponent();
        }
        ...
        {
            _dtDetalle = _dal.EjecutarConsulta("[EORDEN_DESPACHO].SP_DESPACHO_BODEGA_ENC",
                new { ACCION = "LIST" });
        ...
        private int? ObtenerIdFilaActiva()
        {
            ...
            object val = gvDetalle.GetRowCellValue(gvDetalle.FocusedRowHandle, "ID_DBENC");
        ...
        private void gvDetalle_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            if (e.Column == colVER_Q)
            {
                ...
                try
                {
                    ...
                    var reporte = new RptSalidaBodega { _id = (int)id };
