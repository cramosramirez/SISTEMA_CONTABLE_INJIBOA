...
{
    public partial class frmVapores : DevExpress.XtraEditors.XtraForm
    {
        // ------------------------------------------------------------------
        ...
        private void gridView1_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            txtNumVap.Text = view.GetRowCellValue(e.FocusedRowHandle, "NUMVAP")?.ToString();
            ...
            txtNumVap.Properties.ReadOnly = true;
        ...
        // ------------------------------------------------------------------
        private void CargarVapores()
        {
            var dt = _dal.EjecutarConsulta("[EEXPORTACION].[SP_EXP_VAPORES_CONSULTAR]");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                parametros.Add("@NUMVAP", dbType: DbType.Int32, direction: ParameterDirection.Output);
        ...
        {
            if (string.IsNullOrEmpty(txtNumVap.Text))
            {
                Alertas.Advertencia("Seleccione un vapor en la lista.");
                return;
            }
            if (!ValidarCampos()) return;
            ...
            {
                var parametros = new DynamicParameters();
                parametros.Add("@NUMVAP", int.Parse(txtNumVap.Text));
                parametros.Add("@DESCRIPCION", txtDescripcion.Text.Trim());
                parametros.Add("@ESTADO", ObtenerCodigoEstadoSeleccionado());
                ...
                _dal.EjecutarConSalida("[EEXPORTACION].[SP_EXP_VAPORES_ACTUALIZAR]", parametros);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (!Alertas.Confirmar($"¿Eliminar el vapor \"{txtDescripcion.Text}\"?"))
                return;
            ...
            try
            {
                ...
                _dal.EjecutarConSalida("[EEXPORTACION].[SP_EXP_VAPORES_ELIMINAR]", parametros);
        ...
        private bool ValidarCampos()
        {
            ...
            {
                Alertas.Advertencia("Ingrese la descripcion del vapor.");
                txtDescripcion.Focus();
                return false;
            }
            if (ObtenerCodigoEstadoSeleccionado() == null)
            {
                Alertas.Advertencia("Seleccione el estado del vapor.");
                cboEstado.Focus();
                return false;
            }
            return true;
