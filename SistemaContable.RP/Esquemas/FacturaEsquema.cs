...
{
    class FacturaEsquema
    {
        public static DataTable Crear()
        {
            var dt = new DataTable("Factura");
            ...
            dt.Columns.Add("dui", typeof(string));          // FE: consumidor final identificado por DUI
            ...
            dt.Columns.Add("nosujeta", typeof(decimal));    // FE: ventas no sujetas
            dt.Columns.Add("afecta", typeof(decimal));      // ventas gravadas
            dt.Columns.Add("exentatot", typeof(decimal));   // total exento
            dt.Columns.Add("descuento", typeof(decimal));
            dt.Columns.Add("iva", typeof(decimal));         // FE: IVA incluido en el precio
            ...
            dt.Columns.Add("nosujeto", typeof(decimal));    // FE: monto no sujeto de la línea
